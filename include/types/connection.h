...
enum {
	...
	CO_FL_SS_SEND_DEST  = 0x08000000,  /* wait for an SS handshake to complete */

	/* below we have all handshake flags grouped into one */
	CO_FL_HANDSHAKE     = CO_FL_SEND_PROXY | CO_FL_SSL_WAIT_HS | CO_FL_ACCEPT_PROXY | CO_FL_SS_SEND_DEST,
